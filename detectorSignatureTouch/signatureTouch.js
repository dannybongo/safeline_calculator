...
function calculate() {
  ...
  //The Sig-Touch & Sig-Touch RZ share the 4 below calculated dimensions in common
  detector_FootCentresSide_Calc(apetureWidth);
  detector_FlangeThickness_Calc(caseDutyType, caseMaterial);
  detector_CableDim_Calc(caseMaterial);
  ...
  function detector_FlangeThickness_Calc(caseDutyType, caseMaterial) {
  ...
  function detector_CableDim_Calc(caseMaterial) {
    if (caseMaterial.value === "stainlessSteel") {
      document.getElementById("dimension_CableDim").value = 122;
    } else {
      document.getElementById("dimension_CableDim").value = 125;
    }
  }
  function detectorInfo(detectorType) {
    ...
    if (detectorType.value === "signatureTouch") {
      ...
      document.getElementById("outputDetectorInfo").value = information;
    } else {
      ...
      document.getElementById("outputDetectorInfo").innerHTML = information;
    }
  }

  if (detectorType.value === "signatureTouch") {
    signatureTouch_Calc(apetureWidth, apetureHeight, apetureMin, caseMaterial);
  } else {
    signatureTouch_RZ_Calc(apetureWidth, apetureHeight, apetureMin, caseMaterial, array);
  }
}

function signatureTouch_Calc(apetureWidth, apetureHeight, apetureMin, caseMaterial) {
  signatureTouch_DimA_Calc(apetureWidth, apetureHeight);
  signatureTouch_MetalFreeZone_Calc(apetureMin);
  signatureTouch_DetectorWidth_Calc(apetureMin, caseMaterial);
  signatureTouch_FootCentresFront_Calc(apetureMin, caseMaterial);
  signatureTouch_BodyLength_Calc(apetureWidth, dimensionA);
  signatureTouch_OverallHeight_Calc(apetureHeight, dimensionA);
  signatureTouch_Weight_Calc(apetureWidth, apetureHeight, dimensionA, dimensionZ, caseMaterial);
  ...
  function signatureTouch_DetectorWidth_Calc(apetureMin, caseMaterial) {
    if (caseMaterial.value === "stainlessSteel") {
  ...
  function signatureTouch_Weight_Calc(apetureWidth, apetureHeight, dimensionA, dimensionZ, caseMaterial) {
...
function signatureTouch_RZ_Calc(apetureWidth, apetureHeight, apetureMin, caseMaterial, array) {
